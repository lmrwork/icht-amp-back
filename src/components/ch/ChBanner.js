...
class ChBanner extends PureComponent {
  ...
  render() {
    ...
    return (
      <header className="flex justify-start items-center pl2 ch-header" onClick={this.props.onClick}>
        ...
        <a className="text-decoration-none mr2 block ch-header-tailormade" data-href={formData.linkHref}> {formData.linkText} </a>
      </header>
    )
  }
