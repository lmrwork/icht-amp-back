  ...
  render() {
    ...
    return (
      <div onClick={this.props.onClick} className="ChCarousel">
      	<amp-carousel layout="responsive" width={formData.imageWidth} height={formData.imageHeight} type="slides" autoplay delay="3000" loop className={'hi-'+formData.imageList.length}>
